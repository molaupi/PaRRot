...
using UnidirectionalWitnessSearch =
    CH::WitnessSearch<CHCoreGraph, PROFILER, UnidirectionalPopLimit>;
template <typename PROFILER>
using BidirectionalWitnessSearch =
    CH::BidirectionalWitnessSearch<CHCoreGraph, PROFILER,
