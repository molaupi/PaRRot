...
public:
  ULTRARAPTOR(const Data &data, const InitialTransferType initialTransfers,
      ...
      : data(data), initialTransfers(initialTransfers),
        ...
        sourceDepartureTime(never), profiler(profilerTemplate) {
  ...
  ULTRARAPTOR(const Data &data, const CH::CH &chData,
              const Profiler &profilerTemplate = Profiler())
  ...
  template <
      ...
      typename = std::enable_if_t<Meta::Equals<T, TransferGraph>() &&
                                  Meta::Equals<T, InitialTransferGraph>()>>
  ULTRARAPTOR(const Data &data, const TransferGraph &forwardGraph,
              const TransferGraph &backwardGraph,
              const Profiler &profilerTemplate = Profiler())
      : ULTRARAPTOR(data, forwardGraph, backwardGraph, TravelTime,
                    profilerTemplate) {}
