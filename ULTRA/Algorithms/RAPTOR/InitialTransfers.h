...
using BasicInitialAndFinalTransfers =
    CH::UPQuery<USE_STOP_BUCKETS, USE_TARGET_BUCKETS, true, DEBUG>;
template <bool DEBUG>
using SeparatedParetoInitialAndFinalTransfers =
    CH::SeparatedParetoUPQuery<true, DEBUG>;
template <bool DEBUG, size_t MAX_TRIPS>
using GroupedParetoInitialAndFinalTransfers =
    CH::GroupedParetoUPQuery<true, DEBUG, MAX_TRIPS>;
template <bool DEBUG, size_t GROUPED_ROUNDS>
using ParetoInitialAndFinalTransfers =
    Meta::IF<GROUPED_ROUNDS != 0,
