...
void StochasticLib3::MultiWalleniusNCHyp(int32_t *destination, int32_t *source,
  ...
  */
  ...
  int32_t osource[MAXCOLORS];  // contents of source, sorted by weight with
                               // equal weights pooled together
...
int32_t StochasticLib3::FishersNCHypRatioOfUnifoms(int32_t n, int32_t m,
  ...
  */
  ...
  while (1) {
    ...
    lf =
        k * fnc_logb - fc_lnpk(k, L, m, n) - fnc_lfm;  // compute function value
