 ...
 * 5. Replace the old version of the file ERFRES.CPP with ERFRES.H generated
 *here.
 *
...
double ErfC(double x) {
  /* Calculates the error function complement erfc(x) as the
     ...
     This continued fraction is computed forwards in order to facilitate
     detecting when to stop the expansion. The method for computing a continued
     fraction forwards is described in: Peter Henrici: "Applied and
     computational complex analysis", vol. 2, p. 483, 1977.
  */
...
int main() {
  ...
  fprintf(
      ...
      "These tables are used in the Laplace method for calculating Wallenius "
      "noncentral\n"
      "hypergeometric distribution. Used in "
      "CWalleniusNCHypergeometric::laplace() and\n"
      "CMultiWalleniusNCHypergeometric::laplace().\n\n"
      "This file is generated by ERFRESMK.CPP. Please see the file "
      "ERFRESMK.CPP for a\n"
      "detailed description. You must re-run ERFRESMK.CPP if the constants in "
      "STOCC.H\n"
      "are changed.\n\n"
