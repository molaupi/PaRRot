...
public:
    ...
    OneToAllDijkstraRAPTOR(const Data& data, const ULTRACH::CH& chData, const Profiler& profilerTemplate = Profiler()) requires std::same_as<InitialTransferGraph, CHGraph> :
