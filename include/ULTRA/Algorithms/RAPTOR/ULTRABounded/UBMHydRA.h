...
public:
    UBMHydRA(const TripBased::Data& tripData, const TripBased::Data& forwardTBData, const TripBased::Data& backwardTBData, const ULTRACH::CH& chData, const Profiler& profilerTemplate = Profiler()) :
        tripData(tripData),
