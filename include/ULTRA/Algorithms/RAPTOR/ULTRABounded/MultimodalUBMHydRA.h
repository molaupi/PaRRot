...
public:
    MultimodalUBMHydRA(const TripBased::MultimodalData& data, const TripBased::Data& forwardPruningData, const TripBased::Data& backwardPruningData, const TransferGraph& backwardTransitiveGraph, const std::vector<ULTRACH::CH>& chData, const Profiler& profilerTemplate = Profiler()) :
        data(data),
