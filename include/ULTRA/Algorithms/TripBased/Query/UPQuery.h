...
private:
    struct QueryData {
        QueryData(const Data& oldData, const TransferGraph& oldTransferGraph, const ULTRACH::CH& oldCHData, const IndexedSet<false, Vertex>& oldTargets, const bool reorder) :
...
public:
    UPQuery(const Data& oldData, const TransferGraph& oldTransferGraph, const ULTRACH::CH& oldCHData, const IndexedSet<false, Vertex>& oldTargets, const bool reorder) :
