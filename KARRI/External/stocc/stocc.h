...
public:
  ...
  void Multinomial(int32_t *destination, int32_t *source, int32_t n,
                   int colors); // Multinomial distribution
  void
  MultiHypergeometric(int32_t *destination, int32_t *source, int32_t n,
                      int colors); // Multivariate hypergeometric distribution
...
protected:
  ...
  int32_t
  HypInversionMod(int32_t n, int32_t M,
                  int32_t N); // hypergeometric by inversion searching from mode
  int32_t
  HypRatioOfUnifoms(int32_t n, int32_t M,
...
public:
  ...
  int32_t
  FishersNCHyp(int32_t n, int32_t m, int32_t N,
               double odds); // Fisher's noncentral hypergeometric distribution
  void MultiWalleniusNCHyp(int32_t *destination, int32_t *source,
                           double *weights, int32_t n,
                           int colors); // Multivariate Wallenius noncentral
                                        // hypergeometric distribution
  void MultiComplWalleniusNCHyp(
      int32_t *destination, int32_t *source, double *weights, int32_t n,
      int colors); // Multivariate complementary Wallenius noncentral
                   // hypergeometric distribution
  void MultiFishersNCHyp(int32_t *destination, int32_t *source, double *weights,
                         int32_t n,
                         int colors); // Multivariate Fisher's noncentral
                                      // hypergeometric distribution
  // subfunctions for each approximation method
protected:
  ...
  int32_t
  WalleniusNCHypInversion(int32_t n, int32_t m, int32_t N,
  ...
  int32_t
  FishersNCHypRatioOfUnifoms(int32_t n, int32_t m, int32_t N,
...
protected:
  ...
  // parameters generated by findpars and used by probability, laplace,
  // integrate:
...
public:
  ...
  double
  moments(double *mean, double *stddev,
