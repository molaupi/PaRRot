...
# Network containing only roads meant for taxi vehicles
$osmium tags-filter -o ${network}_VehicleHighways.osm.pbf ${network}_Highways.osm.pbf w/highway=motorway,motorway_link,trunk,trunk_link,primary,primary_link,secondary,secondary_link,tertiary,tertiary_link,unclassified,residential,living_street