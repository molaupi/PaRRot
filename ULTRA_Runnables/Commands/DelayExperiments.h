...
#include "../../include/ULTRA/DataStructures/TripBased/Delay.h"
#include "../../include/ULTRA/DataStructures/TripBased/DelayData.h"
#include "../../include/ULTRA/DataStructures/TripBased/DelayInfo.h"
#include "../../include/ULTRA/DataStructures/TripBased/DelayUpdateData.h"

#include "../../include/ULTRA/Algorithms/RAPTOR/DijkstraRAPTOR.h"
#include "../../include/ULTRA/Algorithms/RAPTOR/InitialTransfers.h"
#include "../../include/ULTRA/Algorithms/TripBased/Preprocessing/DelayUpdater.h"
...
public:
    ...
    virtual void execute() noexcept {
        ...
        data.printInfo();
        const ULTRACH::CH bucketCH(getParameter("Bucket CH data"));
...
public:
    ...
    virtual void execute() noexcept {
        ...
        delayData.printInfo();
        ULTRACH::CH coreCH(getParameter("Core CH data"));
        ULTRACH::CH bucketCH(getParameter("Bucket CH data"));
        ...
        ULTRAGraph::move(std::move(dijkstraRaptorData.transferGraph), delayedRaptorData.transferGraph);
...
public:
    ...
    virtual void execute() noexcept {
        ...
        const ULTRACH::CH coreCH(getParameter("Core CH data"));
