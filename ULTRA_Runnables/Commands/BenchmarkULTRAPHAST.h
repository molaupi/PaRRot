...
using CHBuilder = ULTRACH::Builder<Profiler, WitnessSearch, KEY_FUNCTION, STOP_CRITERION, false, false>;
...
inline ULTRACH::CH buildULTRACH(const RAPTOR::Data& data, const std::vector<Vertex>& targets, const double stopFactor, const double targetFactor) noexcept {
