...
`./RawData/TransformLocations -tar-g Networks/Berlin/KARRI/Graphs/Berlin-1pct_pedestrian_veh.gr.bin -v Networks/Berlin/CSV/modified_stops.csv -l-col-name latlon -in-repr lat-lng -out-repr edge-id -o Networks/Berlin/ULTRA/stations.mapped`
